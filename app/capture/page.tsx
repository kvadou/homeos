...
export const metadata: Metadata = { title: 'Build your home memory · GatheredOS', description: 'A guided room-by-room capture of your home.' }
...
export default async function CapturePage() {
  ...
  return <AppShell><div className="space-y-6">
    ...
    <section className="rounded-3xl border border-border bg-card p-5 shadow-sm sm:p-7"><h2 className="font-serif text-2xl">Whole-home essentials</h2><div className="mt-4 space-y-2">
      ...
      <Step complete={emergencyFacts >= 1} icon={ShieldAlert} title="Emergency knowledge" detail={`${emergencyFacts} critical location${emergencyFacts === 1 ? '' : 's'} recorded · shutoffs, panels, extinguishers`} href="/ask" action="Tell GatheredOS" />
    </div></section>
