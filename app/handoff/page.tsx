...
export const metadata: Metadata = { title: 'Home handoff package · HomeOS', description: 'A printable record of the home and its history.' }
...
export default async function HandoffPage() {
  ...
  return <main className="handoff-print mx-auto min-h-screen max-w-5xl bg-white px-5 py-8 text-slate-950 sm:px-10 print:max-w-none print:p-0">
    ...
    <footer className="mt-10 border-t border-slate-300 pt-4 text-xs text-slate-500"><p>Generated from the home&apos;s records in HomeOS. Verify critical details before relying on this package. This copy intentionally contains no private document download links.</p></footer>
  </main>
}
