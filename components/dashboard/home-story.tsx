...
const milestones = [
  '12 projects completed with care',
  'Estimated value increased by ~$94,000',
  'Home Health improved by 11 points',
  'Your home is healthier today than when you bought it',
]
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-sm">
          ...
          <h2 className="mt-2 text-balance font-serif text-3xl leading-tight tracking-tight sm:text-4xl">
            Four years of quiet, consistent care.
          </h2>
