        ...
        <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
          ...
          <div>
            ...
            <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
              {overall == null ? `${counts.unknown} system${counts.unknown === 1 ? '' : 's'} need details before GatheredOS can assess them` : `${counts.green} systems healthy · ${counts.amber} to keep an eye on · ${counts.red} need action`}
            </p>
          </div>
        </div>
