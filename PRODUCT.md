...
The product must not resemble a generic smart-home controller, an engagement-driven AI chatbot, a contractor lead-generation funnel, or a dashboard filled with unsupported health scores. It must avoid fabricated certainty, hidden sponsorship, dark patterns, notification spam, and autonomous external actions the homeowner did not review.
...
Use native iOS interaction patterns, Dynamic Type, VoiceOver labels and ordering, minimum 44-point touch targets, semantic colors that remain legible in Dark Mode and increased contrast, and system motion that respects Reduce Motion. Critical meaning may never depend on color alone.
